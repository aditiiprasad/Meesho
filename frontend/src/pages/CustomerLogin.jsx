...
export default function CustomerLogin() {
 ...
 <div className="min-h-screen flex flex-col items-center justify-center bg-[#F8F6F0] py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
  ...
  <div>
   <h2 className="mt-2 text-center text-3xl font-extrabold text-[#410F29]">Customer Login</h2>
   <p className="mt-2 text-center text-sm text-gray-600 font-medium">Discover great products on Meesho</p>
  </div>
  <form className="mt-8 space-y-6" onSubmit={handleLogin}>
   ...
   <Link to="/customer-register" className="text-[#F47216] hover:text-[#d96213] hover:underline underline-offset-4 transition-all">Sign up</Link>
   </div>
