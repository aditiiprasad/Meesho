...
export default function SellerRegister() {
 ...
 <div className="min-h-screen flex flex-col items-center justify-center bg-[#F8F6F0] bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px] py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
  ...
  <div>
   <h2 className="mt-2 text-center text-3xl font-black uppercase tracking-tight text-[#410F29]">Seller Registration</h2>
   <p className="mt-2 text-center text-sm text-gray-700 font-bold uppercase tracking-wider">Join us and start selling on Meesho</p>
  </div>
  <form className="mt-8 space-y-6" onSubmit={handleRegister}>
   ...
   <Link to="/seller-login" className="text-[#095955] hover:text-[#410F29] hover:underline underline-offset-4 transition-all border-b-2 border-[#095955]">Sign in</Link>
   </div>
