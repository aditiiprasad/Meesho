...
export default function CustomerRegister() {
 ...
 <div className="min-h-screen flex flex-col items-center justify-center bg-[#F8F6F0] py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
  ...
  <div>
   <h2 className="mt-2 text-center text-3xl font-extrabold text-[#410F29]">Customer Registration</h2>
   <p className="mt-2 text-center text-sm text-gray-600 font-medium">Join to discover great products on Meesho</p>
  </div>
  <form className="mt-8 space-y-6" onSubmit={handleRegister}>
   ...
   <div>
    ...
    autoComplete="name"
    required
    className="appearance-none relative block w-full px-4 py-3.5 border border-gray-200 placeholder-gray-400 text-gray-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#F47216] focus:border-transparent sm:text-sm bg-gray-50/50 transition-all"
   ...
   <Link to="/customer-login" className="text-[#F47216] hover:text-[#d96213] hover:underline underline-offset-4 transition-all">Sign in</Link>
   </div>
