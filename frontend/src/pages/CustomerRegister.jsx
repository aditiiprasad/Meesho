...
export default function CustomerRegister() {
 ...
 <div className="min-h-screen flex flex-col items-center justify-center bg-[#F8F6F0] bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px] py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
  ...
  <div>
   <h2 className="mt-2 text-center text-3xl font-black uppercase tracking-tight text-[#410F29]">Customer Registration</h2>
   <p className="mt-2 text-center text-sm text-gray-700 font-bold uppercase tracking-wider">Join Meesho to discover great products</p>
  </div>
  <form className="mt-8 space-y-6" onSubmit={handleRegister}>
   ...
   <Link to="/customer-login" className="text-[#F47216] hover:text-[#410F29] hover:underline underline-offset-4 transition-all border-b-2 border-[#F47216]">Sign in</Link>
   </div>
